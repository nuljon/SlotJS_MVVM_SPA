...
var MESSAGE_TABLE = [
    ...
    'You were broke. So, we fronted you a Benjamin!',
    'Hey friend, bet lower or get more credit!'
];
...
function SlotGame() {
    ...
    function checkLoad() {
      ...
      /*  // redraw canvases if called by orientation change or resize events
        ...
        // fires when player clicks on bet increment/decrement graphics
        function adjustBet(event) {
            //  lets not allow negative bets
            if (bet + event.data.amount > 0) {
                // go ahead and adjust
    ...
    switch (this.state) {
        ...
        case STATE_SLOT2_STOP: // slot 1 stopped, slot 2
            ...
            if (this.stopped2) {
                ...
                this.lastUpdate = now;
                // play reel icon specific audio
                id = this.items2[this.result2].id;
                this.audios[id].play();
            }
            break;
        case STATE_SLOT3_STOP: // slot 2 stopped, slot 3
            ...
            if (this.stopped3) {
                ...
                // play reel icon specific audio
                 id = this.items3[this.result3].id;
                this.audios[id].play();
            }
            break;
